...
const ImageUpload = (props) => {
  ...
  return (
    ...
    >
      ...
      />
      {!progress && (
        <div className="loading w-16 h-16 border-4 border-green-500 border-t-transparent animate-spin absolute z-10 rounded-full"></div>
      )}
      {!image && (
      ...
      {image && (
        <Fragment>
          ...
          <button
            type="button"
            className="w-16 h-16 bg-white rounded-full flex items-center justify-center cursor-pointer absolute z-10 text-red-500"
